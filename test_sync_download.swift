...
func testYtDlpMetadataExtraction() {
    ...
    do {
        ...
        if process.terminationStatus == 0 {
            ...
            print("❌ yt-dlp failed with status \(process.terminationStatus): \(errorString)")
        }
    } catch {
...
func testYtDlpVersion() {
    ...
    do {
        ...
        print("❌ Failed to get yt-dlp version: \(error)")
    }
}

// Main test execution
print("🚀 PodLoad-Mac End-to-End Test Suite (Synchronous)")
print("==================================================")
